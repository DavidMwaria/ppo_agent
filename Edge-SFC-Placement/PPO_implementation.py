...
class PPOMemory():
    ...
    def generate_batches(self):
        ...
        return torch.from_numpy(np.array(self.states)),\
               torch.from_numpy(np.array(self.actions)),\
               torch.from_numpy(np.array(self.action_probs)),\
               torch.from_numpy(np.array(self.vals)),\
               torch.from_numpy(np.array(self.rewards)),\
               torch.from_numpy(np.array(self.dones)),\
               batches
